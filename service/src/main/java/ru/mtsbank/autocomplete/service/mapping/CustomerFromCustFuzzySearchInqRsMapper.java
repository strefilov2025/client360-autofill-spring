...
public interface CustomerFromCustFuzzySearchInqRsMapper {
    String MDM = "MDM";
    ...
    default List<Address> toAddress(final ContactInfoType contactInfoType) {
        if (contactInfoType != null) {
            return toAddress(contactInfoType.getPostAddrs());
        }
        return null;
    }
    ...
    List<Phone> toPhone(List<PhoneNum> addresses);
    ...
    default List<Phone> toPhone(final ContactInfoType contactInfoType) {

        if (contactInfoType != null) {
            return toPhone(contactInfoType.getPhoneNums());
        }
        return null;
    }
    ...
    default List<Email> toEmail(final ContactInfoType contactInfoType) {
        if (contactInfoType == null) {
            return null;
        }
        return (toEmail(contactInfoType.getEmailAddrs()));
    }
