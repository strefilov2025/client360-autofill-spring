...
public class RestV2MockTest {
    ...
    @Test
    public void testOK() {
        CustSearchList clientSAO = mock(CustSearchList.class);
        CustomerDomainGrpcClientSAO customerDomainGrpcClientSAO = mock(CustomerDomainGrpcClientSAO.class);
        ...
        when(clientSAO.sendSearch(anyString(), anyString())).thenReturn(customer);
        when(customerDomainGrpcClientSAO.getCustomerFull(anyString())).thenReturn(customer);
        ...
        CustSearchList old = customerService.custSearchList;
        CustomerDomainGrpcClientSAO oldCD = customerService.customerDomainClient;
        customerService.customerDomainClient = customerDomainGrpcClientSAO;
        customerService.custSearchList = clientSAO;
        ...
        customerService.custSearchList = old;
        customerService.customerDomainClient = oldCD;
    }
    ...
    public void testMtsBankMarshallingException1() {
        MtsbClientSAO mtsbClientSAO = mock(MtsbClientSAO.class);
        ...
        MtsbClientSAO mtsbClientSAOold = customerService.mtsbClientSAO;

        MqGatewayClient oldSearch = customerService.custSearchList.mQClient.mqGatewayClient;
        customerService.mtsbClientSAO = mtsbClientSAO;
        ...
        customerService.mtsbClientSAO = mtsbClientSAOold;
    ...
    public void testNotOK() {
        exceptions.expect(NotFoundRuntimeException.class);
        CustomerDomainGrpcClientSAO clientSAO = mock(CustomerDomainGrpcClientSAO.class);
        when(clientSAO.getCustomerFull(anyString())).thenThrow(new StatusRuntimeException(Status.NOT_FOUND));
        CustSearchList clientSearchSAO = mock(CustSearchList.class);
